...
parser.add_argument('--model_save_path', type=str, default='models_mlp', help='directory to save model')
...
net = nn.Sequential(nn.Linear(784, 5000), nn.ReLU(), nn.Dropout(p=0.9), nn.Linear(5000, 10)).to(device)
net = net.to(device)
